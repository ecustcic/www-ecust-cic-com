...
.customUi-switchToggle.switchToggle-primary
  input:checked
  + label
  .label-switchToggle {
  background-color: #0084ff;
...
.customUi-switchToggle.switchToggle-danger
  input:checked
  + label
  .label-switchToggle {
  background-color: #fa625e;
...
.customUi-switchToggle.switchToggle-success
  input:checked
  + label
  .label-switchToggle {
  background-color: #94df4a;
...
.customUi-switchToggle.switchToggle-info
  input:checked
  + label
  .label-switchToggle {
  background-color: #86d4f5;
...
.customUi-switchToggle.switchToggle-warning
  input:checked
  + label
  .label-switchToggle {
  background-color: #f3d768;
...
.customUi-switchToggle.switchToggle-teal
  input:checked
  + label
  .label-switchToggle {
  background-color: #2cddbe;
...
.customUi-switchToggle.switchToggle-purple
  input:checked
  + label
  .label-switchToggle {
  background-color: #a95ec7;
...
.customUi-switchToggle.switchToggle-pink
  input:checked
  + label
  .label-switchToggle {
  background-color: #f77dc2;
...
.customUi-switchToggle.switchToggle-dark
  input:checked
  + label
  .label-switchToggle {
  background-color: #2c2d3a;
...
.customUi-switchToggle.switchToggle-lg
  input:checked
  + label
  .label-switchToggle:after {
...
.customUi-switchToggle.switchToggle-air
  input:checked
  + label
  .label-switchToggle:after {
...
.customUi-switchToggle.switchToggle-air.switchToggle-lg
  label
  .label-switchToggle {
  width: 52px;
  height: 24px;
...
.offcanvas-wrapper {
  ...
  transition: transform 0.35s ease-in-out, -webkit-transform 0.3s ease-in-out;
  opacity: 0;
...
.sidenav .metisMenu > li.mm-active > .nav-thumbnail,
.sidenav .metisMenu > li.mm-active .nav-text,
.sidenav .metisMenu > li.mm-active a.has-arrow:after {
  opacity: 1;
}
...
.sidenav .metisMenu > li ul > li.mm-active > .nav-thumbnail,
.sidenav .metisMenu > li ul > li.mm-active > a,
...
.darkNav .metisMenu li.mm-active > .nav-thumbnail,
.darkNav .metisMenu li.mm-active .nav-text,
.darkNav .metisMenu li.mm-active > a.has-arrow:after {
  color: #fff;
}
...
.darkNav .metisMenu > li ul > li.mm-active > .nav-thumbnail,
.darkNav .metisMenu > li ul > li.mm-active > a,
